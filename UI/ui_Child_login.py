...
################################################################################
## Form generated from reading UI file 'Child_loginVoIKGq.ui'
##
...
class Child_login(object):
    def setupUi(self, Form):
        ...
        self.label.setStyleSheet(u"background-image: url(assets/logo3.png);")
        self.label.setPixmap(QPixmap(u"assets/logo3.png"))
        ...
        self.label_3.setGeometry(QRect(160, 270, 111, 41))
        font = QFont()
        ...
        self.lineEdit.setGeometry(QRect(300, 280, 151, 21))
        self.lineEdit.setAutoFillBackground(False)
        self.lineEdit.setStyleSheet(u"color: rgb(0, 0, 0);")
        self.lineEdit_2 = QLineEdit(Form)
        self.lineEdit_2.setObjectName(u"lineEdit_2")
        self.lineEdit_2.setGeometry(QRect(300, 330, 151, 21))
